...
// =========================================================================
// Estado da aba Grafos — 100% em memória, sem Firestore/IndexedDB (spec
...
// (grafosTreeState.test.ts) sem precisar mockar rede/Firebase — a mesma
// convenção de driveSyncPlan.ts. Os efeitos de rede ficam em grafosTree.ts
// (o hook `useGrafosVault`).
// =========================================================================
...
export function grafosTreeReducer(state: VaultState, action: VaultAction): VaultState {
  switch (action.type) {
    case 'ROOT_SET':
