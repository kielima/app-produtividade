import type { VaultState } from './obsidianTreeState';
...
// rede, testável isoladamente (obsidianSolarSystem.test.ts). Opera direto
// sobre VaultState, igual a obsidianGraph.ts, mas com duas diferenças
...
//    (ObsidianSolarSystemView.tsx dispara `vault.loadFolderChildren` pra
...
// mesmo espírito do comentário sobre CARD_BASE_WIDTH em ObsidianGraphView.tsx) ---
...
// Exportado para o componente de renderização (ObsidianSolarSystemView.tsx)
...
// componente de renderização (ObsidianSolarSystemView.tsx) precisa do MESMO
...
// `reconcileGraphNodes` em obsidianGraph.ts, só que o campo crítico
