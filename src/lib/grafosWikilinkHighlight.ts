...
import { parseWikilinks } from './grafosWikilink';

// Só o destaque visual de `[[wikilinks]]` — a sintaxe (alvo/alias/cabeçalho)
// mora em grafosWikilink.ts, reaproveitada aqui só para gerar os ranges das
// decorações. Clique-para-navegar fica em GrafosEditor.tsx (Fase 2), em
// cima dos mesmos ranges.

const wikilinkMark = Decoration.mark({ class: 'cm-grafos-wikilink' });
