...
// separada. `ObsidianGraphView` é quem controla posição/tamanho (via `style`
...
export const ObsidianNoteGraphCard = forwardRef<
  HTMLDivElement,
  { note: NoteContentState | undefined }
>(function ObsidianNoteGraphCard({ note }, ref) {
  return (
    <div ref={ref} className="obsidian-note-graph-card" role="group" aria-label="Preview de nota">
