// Mesma lógica de connect-calendar, mas para o Google Drive (aba Leitura).
// Equivalente a functions/src/index.ts `connectDrive`.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    await setRefreshToken(uid, 'drive', json.refresh_token, json.scope ?? DRIVE_SCOPE);
    await setConnectionStatus(admin, uid, 'drive', true);
